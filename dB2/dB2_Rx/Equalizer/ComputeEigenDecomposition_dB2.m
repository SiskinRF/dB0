function [ChannelEstimate, RsCinrdB] = ComputeEigenDecomposition_dB2(RawFreqResponse, SymbolNum)
...
Frequencies       = [-36:1:-1, 1:1:36] * SubcarrierSpacing; 
Times             = ones(1, 72) * OfdmSymbolPeriod * SymbolNum;

DelayRange        = [-1.0e-6 10e-6];
...
EigenVectors(72, :) = 0.0041 - 0.0142i;
