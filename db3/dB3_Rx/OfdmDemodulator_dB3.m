...
for i = 0:NumOfdmSymbols - 1
  ...
  Pos_Index_Range = 1:1:36;
  Neg_Index_Range = 92:1:127;
  ...
  FFT_Time = FFT_Time + 128;
end

% 3. scaling
for i = 1:NumOfdmSymbols
  ResourceGrid(:,i) = ResourceGrid(:,i) / sqrt(128);
